...
angular.module('account').controller('CancelOrderFormController',
    ['$scope', 'AssetsService', 'SessionStorageService', '$state', 'CryptoService', 'loginConfig',
        ...
        function ($scope, AssetsService, SessionStorageService, $state, CryptoService,
            ...
            $scope.cancelOrderForm = angular.copy(multiStepFormScope.canceOrderForm);
            ...
            $scope.cancelOrder = function () {
                var cancelOrderForm = multiStepFormScope.cancelOrderForm;
                ...
                AssetsService.cancelOrder(order, fee, publicKey, type)
